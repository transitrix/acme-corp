...
//
// Vendored from transitrix/methodology scripts/check-adl.mjs (MIT-licensed,
// not part of the plugin payload — see guides/adl-adopter-setup.md §"Getting
// the two scripts"). Copy verbatim; do not fork behaviour here.
