...
Process landscape maps — a top-level catalogue of the organisation's processes, grouped by Operating / Supporting / Management. Each process referenced here resolves to a BusinessProcess element under `canon/elements/02_business/processes/`. Detailed flow diagrams (BPMN) live in `views/bpmn/`.
